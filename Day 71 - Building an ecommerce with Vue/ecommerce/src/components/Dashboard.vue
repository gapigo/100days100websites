        ...
        <v-col cols="12" sm="8" class="pr-0">
          <v-card height="250px" tile flat color="#3890D8">
            <v-row>
              ...
              <v-col cols="12" sm="8">
                <v-img src="bike.png" max-height="400" max-width="400"></v-img>
              </v-col>
            </v-row>
          </v-card>
        </v-col>
      ...
      <v-row>
        <v-col cols="12" sm="3" class="mt-n6 pr-0">
          <v-toolbar flat outlined>
            <v-toolbar-title><strong></strong></v-toolbar-title>
            <v-spacer></v-spacer>
        ...
        <v-col cols="12" sm="3" class="mt-n6 pl-0">
          <v-toolbar flat outlined>
            ...
            <v-spacer></v-spacer>
            <v-badge color="#3853D8" content="3" class="mr-4"></v-badge>
          </v-toolbar>
        </v-col>
        <v-col cols="3" class="py-0 pr-0 mt-n3">
          ...
          <v-card flat outlined tile>
            ...
            <v-chip-group column multiple class="color-chip">
              <v-chip style="color: #000" class="ml-2"></v-chip>
              <v-chip
                style="color: #eaeaea; text-color: black"
                class="ml-2"
              ></v-chip>
              <v-chip style="color: #ffb500" class="ml-2"></v-chip>
              <v-chip style="color: #f27229" class="ml-2"></v-chip>
              <v-chip style="color: #eb3427" class="ml-2"></v-chip>
              <v-chip style="color: #923fa3" class="ml-2"></v-chip>
              <v-chip style="color: #3a51df" class="ml-2"></v-chip>
              <v-chip style="color: #23a7f5" class="ml-2"></v-chip>
              <v-chip style="color: #5eb524" class="ml-2"></v-chip>
              <v-chip style="color: #fc5f4d" class="ml-2"></v-chip>
              <v-chip style="color: #000" class="ml-2"></v-chip>
              <v-chip style="color: lime" class="ml-2"></v-chip>
            </v-chip-group>
          </v-card>
            ...
            >
              <v-hover v-slot:default="{ hover }">
                <v-card height="300" align="center" flat outlined tile>
                  <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="#000000" small dark>{{ clothe.sold }}</v-btn>
                  </v-card-actions>
                  <v-img
                    :src="clothe.image"
                    width="200"
      ...
      <v-row>
        ...
        <v-col cols="12" sm="12">
          <h6 class="text-center grey--text">
            ...
            veritatis quae minima commodi tempora unde soluta incidunt non amet
            officia, velit culpa explicabo quasi repellat odio laudantium
            blanditiis totam maxime.
          </h6>
        </v-col>
        <v-col cols="12" sm="12">
...
export default {
  data: () => ({
    page: 1,
    items: [
      { text: 'Home', disabled: false, href: 'breadcrumbs_home' },
      { text: 'Catalog', disabled: false, href: 'breadcrumbs_catalog' },
      { text: 'Men', disabled: false, href: 'breadcrumbs_men' },
      { text: 'Shoes', disabled: false, href: 'breadcrumbs_shoes' },
    ],
    styles: [
    ...
    clothes: [
      ...
      },
      {
        ...
        sold: '-18%',
        image: '5.png',
        title: 'Nike Air Footscape Magistra Flyknit',
        price: '$ 235.00',
      },
      {
        class: 'py-0 pl-0',
...
.color-chip .v-chip--selected {
  border: 2px solid #111111aa;
}

.color-chip span:not(.v-chip--selected) {
...
.full-list .v-list-item__content {
  display: flex;
