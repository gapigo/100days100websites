      ...
      <v-row>
        <v-col cols="12" sm="4">
          ...
          <v-card-text class="grey--text pt-0">
            ...
            error sint quisquam similique consequuntur veniam delectus autem,
            quis cum eligendi, praesentium deleniti quae exercitationem maxime
            ab. Nobis architecto nihil itaque?
          </v-card-text>
        ...
        <v-col cols="12" sm="2">
          ...
          <v-card-text class="grey--text mt-n4"
            >CA Supply Chains Act</v-card-text
          >
        </v-col>
        <v-col cols="12" sm="4">
